...
//  Scrolling paused and firework audio autoplay 
var timer = null;
var leftsidebar = document.getElementsByClassName('left-sidebar');
window.onscroll = function (e) {
    ...
    if(timer !== null) {
        ...
        for(var i = 0; i<leftsidebar.length; i++){
          leftsidebar[i].style.display = "none";
        }
    }
    timer = setTimeout(function() {
          document.getElementById('body').style.padding = '2rem';
          document.getElementById('body').style.transition = '1s';
          for(var i = 0; i<leftsidebar.length; i++){
            leftsidebar[i].style.display = "flex";
          }
    }, 10000);
};
